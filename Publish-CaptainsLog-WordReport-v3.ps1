...
try {
    ...
    $normal=$document.Styles.Item('Normal');$normal.Font.Name='Aptos';$normal.Font.Size=10
    foreach($level in 1..3){$st=$document.Styles.Item("Heading $level");$st.Font.Name='Aptos Display';$st.Font.Color=0x6F3E14}
