...
if (-not (Test-Path (Join-Path $project "reqs"))) { throw "Kein Captain-Projekt: $project. Zuerst cap init ausfuehren." }
...
if (-not (Test-Path $server)) { throw "Webserver nicht gebaut: $server" }
